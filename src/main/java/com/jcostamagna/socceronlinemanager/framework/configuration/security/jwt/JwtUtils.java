package com.jcostamagna.socceronlinemanager.framework.configuration.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${jcostamagna.app.jwtSecret}")
    private String jwtSecret;

    @Value("${jcostamagna.app.jwtExpirationMs}")
    private int jwtExpirationMs;

    @Value("${jcostamagna.app.jwtCookieName}")
